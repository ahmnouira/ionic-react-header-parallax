;(this.webpackJsonpexample = this.webpackJsonpexample || []).push([
  [18],
  {
    133: function (t, n, i) {
      ...
      var o = i(1),
        r = function (t, n) {
          return null !== n.closest(t)
        },
        e = function (t, n) {
          var i
          return 'string' === typeof t && t.length > 0
            ? Object.assign((((i = { 'ion-color': !0 })['ion-color-' + t] = !0), i), n)
            : n
        },
        a = function (t) {
          var n = {}
        ...
        c = function (t, n, i, r) {
          return Object(o.a)(void 0, void 0, void 0, function () {
            ...
            return Object(o.c)(this, function (o) {
              return null != t && '#' !== t[0] && !d.test(t) && (e = document.querySelector('ion-router'))
                ? (null != n && n.preventDefault(), [2, e.push(t, i, r)])
                : [2, !1]
            })
          })
        }
        ...
        d = (function () {
          function t(t) {
            ...
            Object(r.o)(this, t),
              ...
              (this.onClick = function (t) {
                return Object(o.a)(n, void 0, void 0, function () {
                  var n, i
                  return Object(o.c)(this, function (o) {
                    switch (o.label) {
                      case 0:
                        return (
                          (n = this.el.closest('ion-nav')), t.preventDefault(), (i = n) ? [4, n.canGoBack()] : [3, 2]
                        )
                      case 1:
                        ;(i = o.sent()), (o.label = 2)
                      case 2:
                        return i
                          ? [2, n.pop({ animationBuilder: this.routerAnimation, skipIfBusy: !0 })]
                          : [2, Object(a.d)(this.defaultHref, t, 'back', this.routerAnimation)]
                    }
                  })
                })
              })
          ...
          return (
            (t.prototype.componentWillLoad = function () {
              void 0 === this.defaultHref && (this.defaultHref = e.c.get('backButtonDefaultHref'))
            }),
            Object.defineProperty(t.prototype, 'backButtonIcon', {
              get: function () {
                var t = this.icon
                return null != t
                  ? t
                  : 'ios' === Object(e.b)(this)
                  ? e.c.get('backButtonIcon', 'chevron-back')
                  : e.c.get('backButtonIcon', 'arrow-back-sharp')
              },
              enumerable: !1,
              configurable: !0,
            }),
            Object.defineProperty(t.prototype, 'backButtonText', {
              get: function () {
                var t = 'ios' === Object(e.b)(this) ? 'Back' : null
                return null != this.text ? this.text : e.c.get('backButtonText', t)
              },
              enumerable: !1,
              configurable: !0,
            }),
            Object.defineProperty(t.prototype, 'hasIconOnly', {
              get: function () {
            ...
            Object.defineProperty(t.prototype, 'rippleType', {
              get: function () {
              ...
              return Object(r.j)(
                r.c,
                {
                  ...
                  class: Object(a.a)(
                    ...
                    (t[u] = !0),
                    (t.button = !0),
                    (t['back-button-disabled'] = d),
                    (t['back-button-has-icon-only'] = s),
                    (t['in-toolbar'] = Object(a.c)('ion-toolbar', this.el)),
                    (t['in-toolbar-color'] = Object(a.c)('ion-toolbar[color]', this.el)),
                    (t['ion-activatable'] = !0),
                    (t['ion-focusable'] = !0),
                    (t['show-back-button'] = p),
                    t)
                  ),
                },
                Object(r.j)(
                  'button',
                  { type: c, disabled: d, class: 'button-native', part: 'native', 'aria-label': l || 'back' },
                  Object(r.j)(
                    'span',
                    { class: 'button-inner' },
                    g && Object(r.j)('ion-icon', { part: 'icon', icon: g, 'aria-hidden': 'true', lazy: !1 }),
                    l && Object(r.j)('span', { part: 'text', 'aria-hidden': 'true', class: 'button-text' }, l)
                  ),
                  'md' === u && Object(r.j)('ion-ripple-effect', { type: this.rippleType })
                )
              )
            }),
...
//# sourceMappingURL=18.6aff4325.chunk.js.map
