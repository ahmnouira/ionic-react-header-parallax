        ...
        c = (function () {
          function t(t) {
            ...
            Object(i.o)(this, t),
              ...
              (this.ionSelect = Object(i.g)(this, 'ionSelect', 7)),
              ...
              (this.onClick = function (t) {
                ...
                'ION-SEGMENT' !== o.tagName &&
                  ((e.value = o.value),
                  (!e.scrollable && e.swipeGesture) || (n ? e.checkButton(n, o) : e.setCheckedClasses()),
                  (e.checked = o))
              })
          }
          return (
            ...
            (t.prototype.disabledChanged = function () {
              this.gestureChanged()
              for (var t = 0, e = this.getButtons(); t < e.length; t++) {
                e[t].disabled = this.disabled
              }
            }),
            ...
            (t.prototype.componentDidLoad = function () {
              return Object(n.a)(this, void 0, void 0, function () {
                ...
                return Object(n.c)(this, function (n) {
                  switch (n.label) {
                    case 0:
                      return this.setCheckedClasses(), (t = this), [4, Promise.resolve().then(o.bind(null, 37))]
                    case 1:
                      return (
            ...
            (t.prototype.addRipple = function (t) {
              var e = this
              if (r.c.getBoolean('animated', !0) && r.c.getBoolean('rippleEffect', !0)) {
                var o = this.getButtons().find(function (t) {
                    return t.value === e.value
                  }),
                  n = (o.shadowRoot || o).querySelector('ion-ripple-effect')
                if (n) {
                  var i = Object(a.p)(t.event),
                    s = i.x,
                    c = i.y
                  n.addRipple(s, c).then(function (t) {
                    return t()
                  })
                }
              }
            ...
            (t.prototype.activate = function (t) {
              var e = this,
                o = t.event.target,
                n = this.getButtons().find(function (t) {
                  return t.value === e.value
                })
              'ION-SEGMENT-BUTTON' === o.tagName &&
                (n || ((this.value = o.value), this.setCheckedClasses()),
                this.value === o.value && this.setActivated(!0))
            }),
            ...
            (t.prototype.checkButton = function (t, e) {
              var o = this.getIndicator(t),
                n = this.getIndicator(e)
              if (null !== o && null !== n) {
                var r = o.getBoundingClientRect(),
                  a = n.getBoundingClientRect(),
                  s = r.width / a.width,
                  c = 'translate3d(' + (r.left - a.left) + 'px, 0, 0) scaleX(' + s + ')'
                Object(i.f)(function () {
            ...
            (t.prototype.setCheckedClasses = function () {
              ...
              for (var n = 0, i = e; n < i.length; n++) {
                i[n].classList.remove('segment-button-after-checked')
              }
              o < e.length && e[o].classList.add('segment-button-after-checked')
            }),
            (t.prototype.setNextIndex = function (t, e) {
              ...
              if (-1 !== c) {
                var d = l.getBoundingClientRect(),
                  ...
                  u = t.currentX,
                  h = d.top + d.height / 2,
                  m = document.elementFromPoint(u, h)
                if (a && !e) {
                  if (r ? u > b + g : u < b) (p = c - 1) >= 0 && (i = p)
                  else if (r ? u < b : u > b + g) {
                    var p
                    if (a && !e) (p = c + 1) < s.length && (i = p)
                  }
                  void 0 === i || s[i].disabled || (n = s[i])
                }
                if ((!a && e && (n = m), null != n)) {
                  if ('ION-SEGMENT' === n.tagName) return !1
                  l !== n && this.checkButton(l, n)
                }
                return !0
              }
            }),
              ...
              return Object(i.j)(
                i.c,
                {
                  ...
                  class: Object(s.a)(
                    ...
                    (t['segment-activated'] = this.activated),
          ...
          function t(t) {
            ...
            Object(i.o)(this, t),
              ...
              (this.updateState = function () {
                e.segmentEl && (e.checked = e.segmentEl.value === e.value)
              })
          }
          return (
            (t.prototype.connectedCallback = function () {
              ...
              t &&
                (this.updateState(),
                Object(a.a)(t, 'ionSelect', this.updateState),
                Object(a.a)(t, 'ionStyle', this.updateStyle))
            }),
            (t.prototype.disconnectedCallback = function () {
              var t = this.segmentEl
              t &&
                (Object(a.b)(t, 'ionSelect', this.updateState),
                Object(a.b)(t, 'ionStyle', this.updateStyle),
                (this.segmentEl = null))
            }),
              ...
              return Object(i.j)(
                i.c,
                {
                  ...
                  class:
                    ...
                    (t['in-segment-color'] = null !== b && void 0 !== b.color),
                    (t['segment-button-has-label'] = l),
                    (t['segment-button-has-icon'] = c),
                    (t['segment-button-has-label-only'] = l && !c),
                    (t['segment-button-has-icon-only'] = c && !l),
                    (t['segment-button-disabled'] = a),
                    (t['segment-button-checked'] = o),
                    (t['segment-button-layout-' + d] = !0),
                    (t['ion-activatable'] = !0),
                    (t['ion-activatable-instant'] = !0),
                    (t['ion-focusable'] = !0),
                    t),
                },
                Object(i.j)(
                  'button',
                  { type: n, tabIndex: -1, class: 'button-native', part: 'native', disabled: a },
                  Object(i.j)('span', { class: 'button-inner' }, Object(i.j)('slot', null)),
                  'md' === u && Object(i.j)('ion-ripple-effect', null)
                ),
                Object(i.j)(
                  'div',
                  {
                  ...
                  Object(i.j)('div', { part: 'indicator-background', class: 'segment-button-indicator-background' })
                )
              )
            }),
            Object.defineProperty(t.prototype, 'el', {
      ...
      var n = o(1),
        ...
        r = function (t, e) {
          ...
          return 'string' === typeof t && t.length > 0
            ? Object.assign((((o = { 'ion-color': !0 })['ion-color-' + t] = !0), o), e)
            : e
        },
        a = function (t) {
          var e = {}
          ...
          return Object(n.a)(void 0, void 0, void 0, function () {
            ...
            return Object(n.c)(this, function (n) {
              return null != t && '#' !== t[0] && !s.test(t) && (r = document.querySelector('ion-router'))
                ? (null != e && e.preventDefault(), [2, r.push(t, o, i)])
                : [2, !1]
            })
          })
        }
...
//# sourceMappingURL=34.f2ef85d0.chunk.js.map
