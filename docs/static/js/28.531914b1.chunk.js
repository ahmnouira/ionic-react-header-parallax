;(this.webpackJsonpexample = this.webpackJsonpexample || []).push([
  [28],
  {
    107: function (t, e, n) {
      'use strict'
      n.r(e),
        n.d(e, 'ion_menu', function () {
          return h
        }),
        n.d(e, 'ion_menu_button', function () {
          return v
        }),
        n.d(e, 'ion_menu_toggle', function () {
          return y
        })
      var i = n(1),
        o = n(13),
        ...
        h =
          ...
          (function () {
            function t(t) {
              Object(o.o)(this, t),
                (this.ionWillOpen = Object(o.g)(this, 'ionWillOpen', 7)),
                (this.ionWillClose = Object(o.g)(this, 'ionWillClose', 7)),
                (this.ionDidOpen = Object(o.g)(this, 'ionDidOpen', 7)),
                (this.ionDidClose = Object(o.g)(this, 'ionDidClose', 7)),
                (this.ionMenuChange = Object(o.g)(this, 'ionMenuChange', 7)),
                (this.lastOnEnd = 0),
            ...
            return (
              ...
              (t.prototype.sideChanged = function () {
                this.isEndSide = Object(d.m)(this.side)
              }),
                ...
                return Object(i.a)(this, void 0, void 0, function () {
                  ...
                  return Object(i.c)(this, function (i) {
                    switch (i.label) {
                      case 0:
                        return (
                          void 0 === this.type && (this.type = r.c.get('menuType', 'overlay')),
                          (t = this.el),
                          (e = t.parentNode),
                          ...
                          (o =
                            void 0 !== this.contentId
                              ...
                              : e && e.querySelector && e.querySelector('[main]')) && o.tagName
                            ? ((this.contentEl = o),
                              o.classList.add('menu-content'),
                              this.typeChanged(this.type, void 0),
                              this.sideChanged(),
                              c.a._register(this),
                              (a = this),
                              [4, Promise.resolve().then(n.bind(null, 37))])
                            : (console.error('Menu: must have a "content" element to listen for drag events on.'), [2])
                        )
                      case 1:
                        return (
                          (a.gesture = i.sent().createGesture({
                            el: document,
              ...
              (t.prototype.componentDidLoad = function () {
                return Object(i.a)(this, void 0, void 0, function () {
                  return Object(i.c)(this, function (t) {
                    return (
                      this.ionMenuChange.emit({ disabled: this.disabled, open: this._isOpen }), this.updateState(), [2]
                    )
                  })
                })
              }),
              ...
              (t.prototype.open = function (t) {
                return void 0 === t && (t = !0), this.setOpen(!0, t)
              }),
              (t.prototype.close = function (t) {
                return void 0 === t && (t = !0), this.setOpen(!1, t)
              }),
              (t.prototype.toggle = function (t) {
                return void 0 === t && (t = !0), this.setOpen(!this._isOpen, t)
              }),
              (t.prototype.setOpen = function (t, e) {
                return void 0 === e && (e = !0), c.a._setOpen(this, t, e)
              }),
              (t.prototype._setOpen = function (t, e) {
                return (
                  void 0 === e && (e = !0),
                  Object(i.a)(this, void 0, void 0, function () {
                    return Object(i.c)(this, function (n) {
                      switch (n.label) {
                        case 0:
                          return !this._isActive() || this.isAnimating || t === this._isOpen
                            ? [2, !1]
                            : (this.beforeAnimation(t), [4, this.loadAnimation()])
                        case 1:
                          return n.sent(), [4, this.startAnimation(t, e)]
                        case 2:
                          return n.sent(), this.afterAnimation(t), [2, !0]
                      }
                    })
                  })
                )
              ...
              (t.prototype.loadAnimation = function () {
                return Object(i.a)(this, void 0, void 0, function () {
                  ...
                  return Object(i.c)(this, function (n) {
                    switch (n.label) {
                      case 0:
                        return (t = this.menuInnerEl.offsetWidth) === this.width && void 0 !== this.animation
                          ? [2]
                          : ((this.width = t),
                            this.animation && (this.animation.destroy(), (this.animation = void 0)),
                            (e = this),
                            [4, c.a._createAnimation(this.type, this)])
                      case 1:
                        return (
                          (e.animation = n.sent()),
                          r.c.getBoolean('animated', !0) || this.animation.duration(0),
                    ...
                    switch (i.label) {
                      case 0:
                        return (
                          (n = !t),
                          (o = Object(r.b)(this)),
                          (a = 'ios' === o ? 'cubic-bezier(0.32,0.72,0,1)' : 'cubic-bezier(0.0,0.0,0.2,1)'),
                          (s = 'ios' === o ? 'cubic-bezier(1, 0, 0.68, 0.28)' : 'cubic-bezier(0.4, 0, 0.6, 1)'),
                          (d = this.animation
                            .direction(n ? 'reverse' : 'normal')
                            .easing(n ? s : a)
                            .onFinish(function () {
                              'reverse' === d.getDirection() && d.direction('normal')
                            })),
                          e ? [4, d.play()] : [3, 2]
                        )
                      case 1:
              ...
              (t.prototype.canStart = function (t) {
                return (
                  ...
                  (!!this._isOpen || (!c.a._getOpenSync() && p(window, t.currentX, this.isEndSide, this.maxEdgeStart)))
                )
              }),
              ...
              (t.prototype.onStart = function () {
                this.isAnimating && this.animation
                  ...
                  : Object(d.l)(!1, 'isAnimating has to be true')
              }),
              (t.prototype.onMove = function (t) {
                ...
                } else Object(d.l)(!1, 'isAnimating has to be true')
              }),
              (t.prototype.onEnd = function (t) {
                ...
                if (this.isAnimating && this.animation) {
                  var n = this._isOpen,
                    ...
                    c = t.velocityX,
                    l = r / 2,
                    h = c >= 0 && (c > 0.2 || t.deltaX > l),
                    p = c <= 0 && (c < -0.2 || t.deltaX < -l),
                    m = n ? (i ? h : p) : i ? p : h,
                    b = !n && m
                  n && !m && (b = !0), (this.lastOnEnd = t.currentTime)
                  var f = m ? 0.001 : -0.001,
                    g = s < 0 ? 0.01 : s
                  f += Object(a.a)([0, 0], [0.4, 0], [0.6, 1], [1, 1], Object(d.j)(0, g, 0.9999))[0] || 0
                  var v = this._isOpen ? !m : m
                  this.animation
                    .easing('cubic-bezier(0.4, 0.0, 0.6, 1)')
                    .onFinish(
                      function () {
                        return e.afterAnimation(b)
                      },
                      { oneTimeCallback: !0 }
                    )
                    .progressEnd(v ? 1 : 0, this._isOpen ? 1 - f : f, 300)
                } else Object(d.l)(!1, 'isAnimating has to be true')
              }),
              (t.prototype.beforeAnimation = function (t) {
                Object(d.l)(!this.isAnimating, '_before() should not be called while animating'),
              ...
              (t.prototype.afterAnimation = function (t) {
                Object(d.l)(this.isAnimating, '_before() should be called while animating'),
                  (this._isOpen = t),
                  (this.isAnimating = !1),
                  this._isOpen || this.blocker.unblock(),
                  t
                    ? (this.contentEl && this.contentEl.classList.add(f), this.ionDidOpen.emit())
                    : (this.el.classList.remove(m),
                      this.contentEl && this.contentEl.classList.remove(f),
              ...
              (t.prototype.updateState = function () {
                ...
                this.gesture && this.gesture.enable(t && this.swipeGesture),
                  ...
                  this.disabled || c.a._setActiveMenu(this),
                  Object(d.l)(!this.isAnimating, 'can not be animating')
              }),
              (t.prototype.forceClosing = function () {
                Object(d.l)(this._isOpen, 'menu cannot be closed'),
                  (this.isAnimating = !0),
              ...
              (t.prototype.render = function () {
                ...
                return Object(o.j)(
                  ...
                  Object(o.j)(
                    ...
                    Object(o.j)('slot', null)
                  ),
                  Object(o.j)('ion-backdrop', {
                    ref: function (t) {
            ...
            return Object(i.c)(this, function (i) {
              switch (i.label) {
                case 0:
                  return [4, c.a.get(t)]
                case 1:
                  return (e = i.sent()), (n = e) ? [4, e.isActive()] : [3, 3]
                case 2:
                  ;(n = i.sent()), (i.label = 3)
                case 3:
                  return [2, !!n]
        ...
        v = (function () {
          function t(t) {
            ...
            Object(o.o)(this, t),
              ...
              (this.onClick = function () {
                return Object(i.a)(e, void 0, void 0, function () {
                  return Object(i.c)(this, function (t) {
                    return [2, c.a.toggle(this.menu)]
                  })
                })
              })
          }
          return (
            (t.prototype.componentWillLoad = function () {
              this.inheritedAttributes = Object(d.i)(this.el, ['aria-label'])
            }),
            (t.prototype.componentDidLoad = function () {
            ...
            (t.prototype.visibilityChanged = function () {
              return Object(i.a)(this, void 0, void 0, function () {
                ...
                return Object(i.c)(this, function (e) {
                  switch (e.label) {
                    case 0:
                      return (t = this), [4, g(this.menu)]
                    case 1:
                      return (t.visible = e.sent()), [2]
                  }
                })
              })
            }),
            (t.prototype.render = function () {
              var t,
                ...
                n = e.color,
                i = e.disabled,
                a = e.inheritedAttributes,
                s = Object(r.b)(this),
                d = r.c.get('menuIcon', 'ios' === s ? 'menu-outline' : 'menu-sharp'),
              ...
              return Object(o.j)(
                o.c,
                {
                  ...
                  class: Object(l.a)(
                    ...
                    (t[s] = !0),
                    (t.button = !0),
                    (t['menu-button-hidden'] = c),
                    (t['menu-button-disabled'] = i),
                    (t['in-toolbar'] = Object(l.c)('ion-toolbar', this.el)),
                ...
                Object(o.j)(
                  'button',
                  Object.assign({}, h, { disabled: i, class: 'button-native', part: 'native', 'aria-label': u }),
                  Object(o.j)(
                    'span',
                    { class: 'button-inner' },
                    Object(o.j)(
                      'slot',
                      null,
                      Object(o.j)('ion-icon', { part: 'icon', icon: d, mode: s, lazy: !1, 'aria-hidden': 'true' })
                    )
                  ),
                  'md' === s && Object(o.j)('ion-ripple-effect', { type: 'unbounded' })
                )
              )
            }),
            Object.defineProperty(t.prototype, 'el', {
          ...
          (t.prototype.render = function () {
            ...
            return Object(o.j)(
              o.c,
              {
                ...
                class: ((t = {}), (t[e] = !0), (t['menu-toggle-hidden'] = n), t),
              },
              Object(o.j)('slot', null)
            )
          }),
      ...
      y.style = ':host(.menu-toggle-hidden){display:none}'
    },
    133: function (t, e, n) {
      'use strict'
      n.d(e, 'a', function () {
      ...
      var i = n(1),
        ...
        d = function (t, e, n, o) {
          return Object(i.a)(void 0, void 0, void 0, function () {
            var r
            return Object(i.c)(this, function (i) {
              return null != t && '#' !== t[0] && !s.test(t) && (r = document.querySelector('ion-router'))
                ? (null != e && e.preventDefault(), [2, r.push(t, n, o)])
                : [2, !1]
            })
          })
        }
...
//# sourceMappingURL=28.531914b1.chunk.js.map
