;(this.webpackJsonpexample = this.webpackJsonpexample || []).push([
  [25],
  {
    104: function (t, i, e) {
          ...
          return (
            (t.prototype.render = function () {
              var t,
                ...
                e = i.disabled,
                n = i.expandable,
                a = void 0 === i.href ? 'button' : 'a',
                l = Object(s.b)(this),
                d =
                  'button' === a
                    ? { type: this.type }
                    : { download: this.download, href: this.href, target: this.target }
              return Object(o.j)(
                o.c,
                {
                  ...
                  class: Object(r.a)(
                    ...
                    ((t = {}),
                    (t[l] = !0),
                    (t['item-option-disabled'] = e),
                    (t['item-option-expandable'] = n),
                    (t['ion-activatable'] = !0),
                    t)
                  ),
                },
                Object(o.j)(
                  a,
                  Object.assign({}, d, { class: 'button-native', part: 'native', disabled: e }),
                  Object(o.j)(
                    'span',
                    { class: 'button-inner' },
                    Object(o.j)('slot', { name: 'top' }),
                    Object(o.j)(
                      'div',
                      { class: 'horizontal-wrapper' },
                      Object(o.j)('slot', { name: 'start' }),
                      Object(o.j)('slot', { name: 'icon-only' }),
                      Object(o.j)('slot', null),
                      Object(o.j)('slot', { name: 'end' })
                    ),
                    Object(o.j)('slot', { name: 'bottom' })
                  ),
                  'md' === l && Object(o.j)('ion-ripple-effect', null)
                )
              )
            }),
      ...
      var d = (function () {
        function t(t) {
          Object(o.o)(this, t), (this.ionSwipe = Object(o.g)(this, 'ionSwipe', 7)), (this.side = 'end')
        }
        return (
          (t.prototype.fireSwipeEvent = function () {
            return Object(n.a)(this, void 0, void 0, function () {
              return Object(n.c)(this, function (t) {
                return this.ionSwipe.emit({ side: this.side }), [2]
              })
            })
          }),
          (t.prototype.render = function () {
            var t,
              i = Object(s.b)(this),
              e = Object(a.m)(this.side)
            return Object(o.j)(o.c, {
              class:
                ((t = {}),
                (t[i] = !0),
                (t['item-options-' + i] = !0),
                (t['item-options-start'] = !e),
                (t['item-options-end'] = e),
                t),
            })
          }),
          Object.defineProperty(t.prototype, 'el', {
      ...
      var p,
        c = (function () {
          function t(t) {
            Object(o.o)(this, t),
              (this.ionDrag = Object(o.g)(this, 'ionDrag', 7)),
              (this.item = null),
              (this.openAmount = 0),
          ...
          return (
                  ...
                  switch (n.label) {
                    case 0:
                      return (
                        ...
                        [4, this.updateOptions()]
                      )
                    case 1:
                      return n.sent(), (t = this), [4, Promise.resolve().then(e.bind(null, 37))]
                    case 2:
                      return (
                        (t.gesture = n.sent().createGesture({
                          el: this.el,
            ...
            (t.prototype.getOpenAmount = function () {
              return Promise.resolve(this.openAmount)
            }),
            (t.prototype.getSlidingRatio = function () {
                ...
                return Object(n.c)(this, function (n) {
                  return null === this.item
                    ...
                    ? (void 0 === t && (t = i === this.leftOptions ? 'start' : 'end'),
                      (t = Object(a.m)(t) ? 'end' : 'start'),
                      (e = this.openAmount < 0),
                      (o = this.openAmount > 0),
                      (e && i === this.leftOptions) ||
                        (o && i === this.rightOptions) ||
                        (this.closeOpened(),
                        (this.state = 4),
                        requestAnimationFrame(function () {
                          s.calculateOptsWidth()
                          var i = 'end' === t ? s.optsWidthRightSide : -s.optsWidthLeftSide
                          ;(p = s.el), s.setOpenAmount(i, !1), (s.state = 'end' === t ? 8 : 16)
                        })),
                      [2])
                    : [2]
                })
            ...
            (t.prototype.close = function () {
              return Object(n.a)(this, void 0, void 0, function () {
                return Object(n.c)(this, function (t) {
                  return this.setOpenAmount(0, !0), [2]
                })
              })
            }),
            (t.prototype.closeOpened = function () {
              return Object(n.a)(this, void 0, void 0, function () {
                return Object(n.c)(this, function (t) {
                  return void 0 !== p ? (p.close(), (p = void 0), [2, !0]) : [2, !1]
                })
              })
            }),
            ...
            (t.prototype.updateOptions = function () {
              return Object(n.a)(this, void 0, void 0, function () {
                ...
                return Object(n.c)(this, function (n) {
                  switch (n.label) {
                    case 0:
                      ;(t = this.el.querySelectorAll('ion-item-options')),
                        (i = 0),
                        (this.leftOptions = this.rightOptions = void 0),
                        (e = 0),
                        (n.label = 1)
                    case 1:
                      return e < t.length
                        ? void 0 === (o = t.item(e)).componentOnReady
                          ? [3, 3]
                    ...
                    case 4:
                      ;(s = r),
                        'start' === (Object(a.m)(s.side) ? 'end' : 'start')
                          ? ((this.leftOptions = s), (i |= 1))
                          : ((this.rightOptions = s), (i |= 2)),
                        (n.label = 5)
                    case 5:
                      return e++, [3, 1]
                    case 6:
                      return (this.optsDirty = !0), (this.sides = i), [2]
                  }
                })
              })
            }),
            (t.prototype.canStart = function (t) {
              if ('rtl' === document.dir ? window.innerWidth - t.startX < 15 : t.startX < 15) return !1
              return p && p !== this.el && this.closeOpened(), !(!this.rightOptions && !this.leftOptions)
            }),
            (t.prototype.disableContentScrollY = function () {
              null !== this.closestContent &&
                ((this.initialContentScrollY = this.closestContent.scrollY), (this.closestContent.scrollY = !1))
            }),
            (t.prototype.restoreContentScrollY = function () {
            ...
            (t.prototype.onMove = function (t) {
              ...
              e > this.optsWidthRightSide
                ? (e = (i = this.optsWidthRightSide) + 0.55 * (e - i))
                : e < -this.optsWidthLeftSide && (e = (i = -this.optsWidthLeftSide) + 0.55 * (e - i)),
            ...
            (t.prototype.calculateOptsWidth = function () {
              ;(this.optsWidthRightSide = 0),
                this.rightOptions &&
            ...
            (t.prototype.setOpenAmount = function (t, i) {
              var e = this
            ...
            (t.prototype.getSlidingRatioSync = function () {
            ...
            (t.prototype.render = function () {
              ...
              return Object(o.j)(o.c, {
                class:
                  ((t = {}),
                  (t[i] = !0),
                  (t['item-sliding-active-slide'] = 2 !== this.state),
                  (t['item-sliding-active-options-end'] = 0 !== (8 & this.state)),
                  (t['item-sliding-active-options-start'] = 0 !== (16 & this.state)),
                  (t['item-sliding-active-swipe-end'] = 0 !== (32 & this.state)),
                  (t['item-sliding-active-swipe-start'] = 0 !== (64 & this.state)),
                  t),
              })
            }),
            Object.defineProperty(t.prototype, 'el', {
      ...
      var n = e(1),
        ...
        s = function (t, i) {
          ...
          return 'string' === typeof t && t.length > 0
            ? Object.assign((((e = { 'ion-color': !0 })['ion-color-' + t] = !0), e), i)
            : i
        },
        r = function (t) {
          var i = {}
        ...
        l = function (t, i, e, o) {
          return Object(n.a)(void 0, void 0, void 0, function () {
            var s
            return Object(n.c)(this, function (n) {
              return null != t && '#' !== t[0] && !a.test(t) && (s = document.querySelector('ion-router'))
                ? (null != i && i.preventDefault(), [2, s.push(t, e, o)])
                : [2, !1]
            })
          })
        }
...
//# sourceMappingURL=25.fbc2daf4.chunk.js.map
