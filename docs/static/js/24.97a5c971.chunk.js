        ...
        s = (function () {
          function t(t) {
            ...
            Object(o.o)(this, t),
              ...
              (this.onInput = function (t) {
                var n = t.target
                n && (i.value = n.value || ''), i.ionInput.emit(t)
              }),
              (this.onBlur = function (t) {
                ;(i.hasFocus = !1), i.focusChanged(), i.emitStyle(), i.fireFocusEvents && i.ionBlur.emit(t)
              }),
              (this.onFocus = function (t) {
                ;(i.hasFocus = !0), i.focusChanged(), i.emitStyle(), i.fireFocusEvents && i.ionFocus.emit(t)
              }),
              (this.onKeydown = function (t) {
                i.shouldClearOnEdit() &&
                  (i.didBlurAfterEdit && i.hasValue() && 'Enter' !== t.key && i.clearTextInput(),
                  (i.didBlurAfterEdit = !1))
              }),
              (this.clearTextOnEnter = function (t) {
                'Enter' === t.key && i.clearTextInput(t)
              }),
              (this.clearTextInput = function (t) {
                i.clearInput &&
                  ...
                  !i.disabled &&
                  t &&
                  (t.preventDefault(), t.stopPropagation(), i.setFocus()),
                  (i.value = ''),
          ...
          return (
            (t.prototype.debounceChanged = function () {
              this.ionChange = Object(r.f)(this.ionChange, this.debounce)
            }),
            (t.prototype.disabledChanged = function () {
              this.emitStyle()
            }),
            (t.prototype.placeholderChanged = function () {
              this.emitStyle()
            }),
            ...
            (t.prototype.componentWillLoad = function () {
              this.inheritedAttributes = Object(r.i)(this.el, ['aria-label', 'tabindex', 'title'])
            }),
            ...
            (t.prototype.setFocus = function () {
              return Object(e.a)(this, void 0, void 0, function () {
                return Object(e.c)(this, function (t) {
            ...
            (t.prototype.setBlur = function () {
              return Object(e.a)(this, void 0, void 0, function () {
                return Object(e.c)(this, function (t) {
                  return this.nativeInput && this.nativeInput.blur(), [2]
                })
              })
            }),
            ...
            (t.prototype.shouldClearOnEdit = function () {
              var t = this.type,
                i = this.clearOnEdit
            ...
            (t.prototype.focusChanged = function () {
              ...
              return (
                ...
                Object(o.j)(
                  o.c,
                  {
                    ...
                    class: Object(l.a)(
                      this.color,
                      ((t = {}), (t[n] = !0), (t['has-value'] = this.hasValue()), (t['has-focus'] = this.hasFocus), t)
                    ),
                  },
                  Object(o.j)(
                    'input',
      ...
      var e = n(1),
        ...
        a = function (t, i) {
          ...
          return 'string' === typeof t && t.length > 0
            ? Object.assign((((n = { 'ion-color': !0 })['ion-color-' + t] = !0), n), i)
            : i
        },
        r = function (t) {
          var i = {}
        ...
        s = function (t, i, n, o) {
          return Object(e.a)(void 0, void 0, void 0, function () {
            ...
            return Object(e.c)(this, function (e) {
              return null != t && '#' !== t[0] && !l.test(t) && (a = document.querySelector('ion-router'))
                ? (null != i && i.preventDefault(), [2, a.push(t, n, o)])
                : [2, !1]
            })
          })
        }
...
//# sourceMappingURL=24.97a5c971.chunk.js.map
